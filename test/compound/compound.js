...
describe("Compound", function () {
  ...
  describe("Testing filter for CDAI", function () {
    ...
    it("Should accept to approve the cDAI contract on the DAI token", async function () {
    ...
    it("Should reject to approve the cDAI contract on another ERC20 token", async function () {
